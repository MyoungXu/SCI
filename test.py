...
parser.add_argument('--data_path', type=str, default='./data/' + YOUR_FOLDER,
                    help='location of the data corpus')
parser.add_argument('--save_path', type=str, default='./results/' + YOUR_FOLDER, help='location of the data corpus')
